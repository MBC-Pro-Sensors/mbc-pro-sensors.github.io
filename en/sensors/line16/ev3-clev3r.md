...
<div style="display: flex; align-items: center; justify-content: center; gap: 30px; margin: 30px 0; flex-wrap: wrap;">
  <div style="background: rgba(10,186,181,0.03); border: 1px solid rgba(10,186,181,0.25); border-radius: 12px; padding: 15px 35px; display: flex; align-items: center; gap: 20px; box-shadow: 0 10px 30px rgba(0,0,0,0.15);">
    ...
    <img src="../images/hubs/ev3-clev3r-app.webp" alt="EV3 clev3r App" style="max-height: 90px; object-fit: contain; filter: drop-shadow(0 0 15px rgba(10,186,181,0.15));" />
  </div>
</div>

> [!WARNING] 
> **Please Note: You are currently viewing the tutorial for the 【EV3 clev3r (BASIC)】 environment.**
> If you are using SPIKE or other EV3 software, please click the button above to return to the hub menu and reselect.

Applicable to **clev3r v1.7.1.0** (BASIC language development environment for EV3). In this environment, the Pathfinder 16-Way Sensor will be perfectly identified by the LEGO system as an official **Infrared Sensor**.
...
> clev3r uses BASIC syntax, but the sensor reading modes are exactly the same as the official EV3 software: Proximity / Beacon / Remote modes. The returned value ranges are also completely identical. You can read them using BASIC commands like `IR_PROXIMITY` / `IR_BEACON` / `IR_REMOTE`.

---

## Read Line Position — Proximity Mode

Use BASIC commands to read Proximity mode values.
    ...
    <tbody>
      <tr class="table-hover-row" style="border: none; background: rgba(0,0,0,0.01); transition: background 0.2s ease;">
        ...
        <td style="padding: 18px 20px; color: #444; line-height: 1.6; vertical-align: middle;">
          👉 <strong><code>0</code> = black line is dead center, negative is left, positive is right</strong>; <code>±16</code> means the line is at the very edge of the sensor.
        </td>
      </tr>
    </tbody>
  </table>
...
## Read 16-Channel Photoelectric Reflection Values — Beacon Mode

Use BASIC commands to read the Beacon mode value list (8 bytes).
  ...
  <table style="width: 100%; border-collapse: collapse; text-align: left; font-size: 0.95rem;">
    ...
    <tbody>
      ...
      <tr class="table-hover-row" style="border-bottom: 1px solid rgba(0,0,0,0.06); background: rgba(0,0,0,0.01); transition: background 0.2s ease;">
        ...
        <td style="padding: 18px 20px; font-weight: bold; color: #333; vertical-align: middle;">Reflectance Ch8 + 9</td>
        <td style="padding: 18px 20px; color: #444; vertical-align: middle;"><span style="display: inline-block; background: rgba(10,186,181,0.15); color: #007a75; padding: 2px 8px; border-radius: 4px; font-family: monospace; font-size: 0.85rem; border: 1px solid rgba(10,186,181,0.2);">11 ~ 99</span></td>
        <td style="padding: 18px 20px; color: #444; line-height: 1.6; vertical-align: middle;">Tens digit = Ch8, Units digit = Ch9</td>
      </tr>
      <tr class="table-hover-row" style="border-bottom: 1px solid rgba(0,0,0,0.06); background: rgba(0,0,0,0.01); transition: background 0.2s ease;">
        <td style="padding: 18px 20px; font-weight: bold; color: #111; vertical-align: middle;">5</td>
        <td style="padding: 18px 20px; font-weight: bold; color: #333; vertical-align: middle;">Reflectance Ch10 + 11</td>
        <td style="padding: 18px 20px; color: #444; vertical-align: middle;"><span style="display: inline-block; background: rgba(10,186,181,0.15); color: #007a75; padding: 2px 8px; border-radius: 4px; font-family: monospace; font-size: 0.85rem; border: 1px solid rgba(10,186,181,0.2);">11 ~ 99</span></td>
        <td style="padding: 18px 20px; color: #444; line-height: 1.6; vertical-align: middle;">Tens digit = Ch10, Units digit = Ch11</td>
      </tr>
      <tr class="table-hover-row" style="border-bottom: 1px solid rgba(0,0,0,0.06); background: rgba(0,0,0,0.01); transition: background 0.2s ease;">
        <td style="padding: 18px 20px; font-weight: bold; color: #111; vertical-align: middle;">6</td>
        <td style="padding: 18px 20px; font-weight: bold; color: #333; vertical-align: middle;">Reflectance Ch12 + 13</td>
        <td style="padding: 18px 20px; color: #444; vertical-align: middle;"><span style="display: inline-block; background: rgba(10,186,181,0.15); color: #007a75; padding: 2px 8px; border-radius: 4px; font-family: monospace; font-size: 0.85rem; border: 1px solid rgba(10,186,181,0.2);">11 ~ 99</span></td>
        <td style="padding: 18px 20px; color: #444; line-height: 1.6; vertical-align: middle;">Tens digit = Ch12, Units digit = Ch13</td>
      </tr>
      <tr class="table-hover-row" style="border: none; background: rgba(0,0,0,0.01); transition: background 0.2s ease;">
        <td style="padding: 18px 20px; font-weight: bold; color: #111; vertical-align: middle;">7</td>
        <td style="padding: 18px 20px; font-weight: bold; color: #333; vertical-align: middle;">Reflectance Ch14 + 15</td>
        <td style="padding: 18px 20px; color: #444; vertical-align: middle;"><span style="display: inline-block; background: rgba(10,186,181,0.15); color: #007a75; padding: 2px 8px; border-radius: 4px; font-family: monospace; font-size: 0.85rem; border: 1px solid rgba(10,186,181,0.2);">11 ~ 99</span></td>
        <td style="padding: 18px 20px; color: #444; line-height: 1.6; vertical-align: middle;">Tens digit = Ch14, Units digit = Ch15</td>
      </tr>
    </tbody>
  </table>
</div>
...
Use BASIC commands to read the Remote mode value list (4 bytes).
  ...
  <table style="width: 100%; border-collapse: collapse; text-align: left; font-size: 0.95rem;">
    ...
    <tbody>
      ...
      <tr class="table-hover-row" style="border-bottom: 1px solid rgba(0,0,0,0.06); background: rgba(0,0,0,0.01); transition: background 0.2s ease;">
        ...
        <td style="padding: 18px 20px; color: #444; line-height: 1.6; vertical-align: middle;">
          👉 <code>dataIrCalib[15]</code> The reflected light of the leftmost sensor. <code>0</code>=pure black, <code>100</code>=pure white. Can be used to detect track boundaries or forks.
        </td>
      </tr>
      <tr class="table-hover-row" style="border: none; background: rgba(0,0,0,0.01); transition: background 0.2s ease;">
...
> 💡 **Tactical Fool-Proofing Tip**: Byte 2 and Byte 3 in Remote mode allow you to directly obtain the extreme edge light values on both sides of the sensor in clev3r (BASIC). If both values are simultaneously less than 20, it means the front of the car has completely entered the horizontal line of an intersection; if one side's value suddenly changes, it means a fork is approaching. This is the ultimate weapon to prevent losing the line!
...
## <a href="../examples/line16/ev3/line16_ev3_clev3r.bp" target="_blank" data-ignore="true" download>📥 Download Example Programs</a>

<div style="text-align: center; margin: 25px 0;">
  <img src="../images/sensors/line16/ev3-clev3r-example.webp" alt="clev3r Example Code Block Example" style="max-width: 100%; border-radius: 8px; border: 1px solid rgba(10,186,181,0.25); box-shadow: 0 10px 30px rgba(0,0,0,0.5); filter: drop-shadow(0 0 15px rgba(10,186,181,0.15));" />
  <p style="font-size: 0.85rem; color: #888; margin-top: 10px;">💡 The image above demonstrates the classic PID line-following program structure in clev3r (EV3) for the 16-Way Line Follower.</p>
</div>

* <a href="../examples/line16/ev3/line16_ev3_clev3r.bp" target="_blank" download="line16_ev3_clev3r.bp" style="color: #0abab5; font-weight: bold; text-decoration: none;">📥 clev3r Example (.bp) </a>

---

## 🧩 EV3 Exclusive Subroutines Explanation

To make programming in EV3 clev3r (BASIC) more concise and intuitive, the MBC 16-Way Line Follower provides three powerful "Subroutines". During development, you don't need to install cumbersome extension packs; just call the corresponding function in the main program, and the system will automatically parse the hardware packets in the background and store the latest sensor data in exclusive variables for the motor control logic to use directly.

Here is an introduction to the functions and usage timings of the three core subroutines:

### 1. Basic Line Following Subroutine: `LinePos16_dataUpdate`
* **Purpose**: Quickly read the most basic 16-segment line position, suitable for beginner tutorials and basic left/right steering judgments.
* **Parameters and Returns**: Input sensor port (`port`), returns variable `pos16`.
* **Value Parsing**: The range is between `-16` and `+16`.
...
### 2. Competitive High-Precision Subroutine: `LinePos100_dataUpdate`
...
* **Parameters and Returns**: Input sensor port (`port`), synchronously returns several key variables:
  * `pos100`: High-precision position, range `-100` to `+100` (also maintains the standard of left negative, right positive).
  * `width`: Real-time line width detection, the value represents the number of currently triggered sensors (range `0` to `16`). Can be used to accurately judge intersections, T-junctions, or the finish stop line.
  * `ch1` / `ch16`: Synchronously read the physical light values of the rightmost (`ch1`) and leftmost (`ch16`) sensors (range `0` to `100`), making it convenient for users to adjust advanced strategies such as anti-derailment or intersections.

### 3. Full Array Decoding Subroutine: `LineCh16_dataUpdate`
* **Purpose**: Thoroughly decode the 16 sensors into independent states. Applicable for writing custom special intersection judgment algorithms, triggering monitoring of sensors at specific positions, or drawing the sensor status directly on the screen of the EV3 hub.
* **Parameters and Returns**: Input sensor port (`port`), the subroutine will instantly parse and return the array `light16`. You can obtain the real-time quantized light value of each sensor through the index (`light16[0]` to `light16[15]`) (value range `1` to `9`, 1=darkest, 9=brightest).

> [!TIP]
> **💡 Development Tip**
> The underlying technology of these three functions cleverly utilizes the multi-channel switching (Channel 1~4) of the built-in EV3 infrared sensor (set to Port 4) to transmit a large amount of data. During actual development, **as long as you put these exclusive subroutines into an infinite Loop**, you can ensure the line-following robot grasps the most real-time track information at all times!
