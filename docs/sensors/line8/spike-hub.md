...
<div style="display: flex; align-items: center; justify-content: center; gap: 30px; margin: 30px 0; flex-wrap: wrap;">
  <div style="background: rgba(10,186,181,0.03); border: 1px solid rgba(10,186,181,0.25); border-radius: 12px; padding: 25px 45px; display: flex; align-items: center; gap: 25px; box-shadow: 0 10px 30px rgba(0,0,0,0.15);">
    <img src="../images/sensors/line8/line8-product-spike.webp" alt="循行者8路感應器" style="max-height: 144px; object-fit: contain; filter: drop-shadow(0 0 20px rgba(242,194,0,0.75)) drop-shadow(0 0 45px rgba(242,194,0,0.45));" />
...
歡迎來到 SPIKE 專區！循行者 8 路感應器完美支援以下兩款樂高旗艦主機系統：
...
<div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 20px; margin: 25px 0;">
  ...
  <div style="background: rgba(242,194,0,0.04); border: 1px solid rgba(242,194,0,0.25); border-radius: 12px; padding: 25px; display: flex; flex-direction: column; align-items: center; text-align: center;">
    ...
    <h3 style="color: #f2c200; margin: 0 0 15px 0; font-size: 1.3rem;">🟡 SPIKE Prime 教育版 (黃色主機)</h3>
    <div style="font-size: 1rem; line-height: 1.8; color: #ddd; border-top: 1px solid rgba(242,194,0,0.15); padding-top: 15px; width: 100%;">
      LEGO® Education SPIKE™ Prime Set<br>
      樂高®教育 SPIKE™ Prime 科創套裝
    </div>
  </div>
  ...
  <div style="background: rgba(10,186,181,0.04); border: 1px solid rgba(10,186,181,0.25); border-radius: 12px; padding: 25px; display: flex; flex-direction: column; align-items: center; text-align: center;">
    ...
    <h3 style="color: #0abab5; margin: 0 0 15px 0; font-size: 1.3rem;">🟢 Robot Inventor 家用版 (藍綠色主機)</h3>
    <div style="font-size: 1rem; line-height: 1.8; color: #ddd; border-top: 1px solid rgba(10,186,181,0.15); padding-top: 15px; width: 100%;">
      LEGO® MINDSTORMS® Robot Inventor<br>
      樂高® MINDSTORMS® 機器人發明家
    </div>
  </div>
</div>
...
> [!NOTE]
> 在官方積木 App 中，感應器預設會**模擬成「SPIKE 顏色感應器」**，並利用特殊編碼技術將 8 路數據封裝在顏色、反射光與 RGB 通道中。

請點擊下方符合您使用情境的環境，查看對應的安裝與程式積木教學：

<div class="env-hub-grid">
  <!-- 卡片 1 -->
  <a href="#/sensors/line8/spike-education" class="env-card spike" style="display: flex; flex-direction: column; align-items: center; justify-content: center; min-height: 220px; padding: 30px 20px;">
  ...
  <!-- 卡片 2 -->
  <a href="#/sensors/line8/spike-ri" class="env-card spike" style="display: flex; flex-direction: column; align-items: center; justify-content: center; min-height: 220px; padding: 30px 20px;">
  ...
  <!-- 卡片 3 -->
  <a href="#/sensors/line8/spike-pybricks" class="env-card spike" style="display: flex; flex-direction: column; align-items: center; justify-content: center; min-height: 220px; padding: 30px 20px;">
