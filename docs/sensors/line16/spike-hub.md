...
<div style="display: flex; align-items: center; justify-content: center; gap: 30px; margin: 30px 0; flex-wrap: wrap;">
  <div style="background: rgba(10,186,181,0.03); border: 1px solid rgba(10,186,181,0.25); border-radius: 12px; padding: 25px 45px; display: flex; align-items: center; gap: 25px; box-shadow: 0 10px 30px rgba(0,0,0,0.15);">
    <img src="../images/sensors/line16/line16-product-spike.webp" alt="循行者16路感應器" style="max-height: 144px; object-fit: contain; filter: drop-shadow(0 0 20px rgba(10,186,181,0.75)) drop-shadow(0 0 45px rgba(10,186,181,0.45));" />
...
> [!NOTE]
> 在官方積木 App 中，感應器預設會**模擬成「SPIKE 顏色感應器」**，並利用特殊編碼技術將 16 路數據封裝在顏色、反射光與 RGB 通道中。

請點擊下方符合您使用情境的環境，查看對應的安裝與程式積木教學：

<div class="env-hub-grid">
  <!-- 卡片 1 -->
  <a href="#/sensors/line16/spike-education" class="env-card spike" style="display: flex; flex-direction: column; align-items: center; justify-content: center; min-height: 220px; padding: 30px 20px;">
  ...
  <!-- 卡片 2 -->
  <a href="#/sensors/line16/spike-ri" class="env-card spike" style="display: flex; flex-direction: column; align-items: center; justify-content: center; min-height: 220px; padding: 30px 20px;">
  ...
  <!-- 卡片 3 -->
  <a href="#/sensors/line16/spike-pybricks" class="env-card spike" style="display: flex; flex-direction: column; align-items: center; justify-content: center; min-height: 220px; padding: 30px 20px;">
