# 🧱 SPIKE Series Hubs (8-Way Line Follower)
...
<div style="display: flex; align-items: center; justify-content: center; gap: 30px; margin: 30px 0; flex-wrap: wrap;">
  <div style="background: rgba(10,186,181,0.03); border: 1px solid rgba(10,186,181,0.25); border-radius: 12px; padding: 25px 45px; display: flex; align-items: center; gap: 25px; box-shadow: 0 10px 30px rgba(0,0,0,0.15);">
    <img src="../images/sensors/line8/line8-product-spike.webp" alt="Pathfinder 8-Way Sensor" style="max-height: 144px; object-fit: contain; filter: drop-shadow(0 0 20px rgba(242,194,0,0.75)) drop-shadow(0 0 45px rgba(242,194,0,0.45));" />
...
Welcome to the SPIKE zone! The Pathfinder 8-Way Sensor perfectly supports the following two flagship LEGO hub systems:
...
> [!NOTE]
> In the official block Apps, the sensor will by default **emulate a "SPIKE Color Sensor"**, utilizing special encoding techniques to package the 8-channel data into the color, reflected light, and RGB channels.
...
<div class="env-hub-grid">
  <!-- Card 1 -->
  <a href="#/en/sensors/line8/spike-education" class="env-card spike" style="display: flex; flex-direction: column; align-items: center; justify-content: center; min-height: 220px; padding: 30px 20px;">
  ...
  <!-- Card 2 -->
  <a href="#/en/sensors/line8/spike-ri" class="env-card spike" style="display: flex; flex-direction: column; align-items: center; justify-content: center; min-height: 220px; padding: 30px 20px;">
  ...
  <!-- Card 3 -->
  <a href="#/en/sensors/line8/spike-pybricks" class="env-card spike" style="display: flex; flex-direction: column; align-items: center; justify-content: center; min-height: 220px; padding: 30px 20px;">
