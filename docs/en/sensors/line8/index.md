...
<div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 20px; margin: 25px 0;">
  ...
  <div style="background: rgba(255,69,0,0.05); border: 1px solid rgba(255,69,0,0.3); border-radius: 8px; padding: 20px; display: flex; flex-direction: column; justify-content: space-between;">
    <h4 style="color: #ff4500; margin-top: 0; font-size: 1.15rem; margin-bottom: 10px;">📐 Feature Line Width & Binarized Map</h4>
    <p style="font-size: 0.95em; margin: 0; line-height: 1.6; color: #ccc;">Reports the number of currently triggered sensors (line width — useful for detecting intersections, T-junctions, and right angles), as well as the binarized trigger state of all 8 sensors for fine trajectory reconstruction.</p>
  </div>
  <div style="background: rgba(0,210,255,0.05); border: 1px solid rgba(0,210,255,0.3); border-radius: 8px; padding: 20px; display: flex; flex-direction: column; justify-content: space-between;">
    <h4 style="color: #00d2ff; margin-top: 0; font-size: 1.15rem; margin-bottom: 10px;">🛡️ Advanced Anti-Interference Filter</h4>
    <p style="font-size: 0.95em; margin: 0; line-height: 1.6; color: #ccc;">Designed for complex WRO maps. The system continuously filters out non-contiguous noise blocks and force-locks onto the main track black line, dramatically reducing the risk of losing the track due to surrounding pattern interference.</p>
  </div>
</div>
...
<div style="display: flex; flex-direction: column; gap: 12px; margin: 20px 0;">
  ...
  <div style="display: flex; align-items: center; gap: 15px; background: rgba(0, 210, 255, 0.06); border: 1px solid rgba(0, 210, 255, 0.25); border-radius: 8px; padding: 12px 15px;">
    ...
    <div style="flex: 1;">
      <strong style="color: #00d2ff; font-size: 1.05rem;">Onboard 8-Channel Status LED Array</strong>
      <div style="color: #ddd; font-size: 0.95rem; margin-top: 4px; line-height: 1.5;">
...
To get the best comparison gain from all 8 photoelectric sensors, this product provides a simple and efficient auto-calibration system:
...
- **❓ Why did the robot follow a flashy pattern on the side?**
  → The 8-Way has a very strong anti-interference filter, but it still requires a **correct calibration baseline**. Make sure calibration covered both "the darkest black line" and "the whitest white area". Check that lighting is even and that sensor height is 0.5 to 1.2 cm.
