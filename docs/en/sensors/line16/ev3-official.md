...
Applicable to the **LEGO® MINDSTORMS® EV3 Official Software** (LabVIEW style interface, often referred to as EV3-G). In this environment, the Pathfinder 16-Way Sensor will be perfectly identified by the LEGO system as an official **Infrared Sensor**.
...
## <a href="../examples/line16/ev3/line16_ev3_official.ev3" target="_blank" data-ignore="true" download>📥 Download Example Programs</a>

<div style="text-align: center; margin: 25px 0;">
  <img src="../images/sensors/line16/ev3-official-example.webp" alt="LEGO® MINDSTORMS® EV3 Official Block Example" style="max-width: 100%; border-radius: 8px; border: 1px solid rgba(10,186,181,0.25); box-shadow: 0 10px 30px rgba(0,0,0,0.5); filter: drop-shadow(0 0 15px rgba(10,186,181,0.15));" />
  <p style="font-size: 0.85rem; color: #888; margin-top: 10px;">💡 The image above demonstrates the classic PID line-following program structure in EV3-G for the 16-Way Line Follower.</p>
</div>

* <a href="../examples/line16/ev3/line16_ev3_official.ev3" target="_blank" download="line16_ev3_official.ev3" style="color: #0abab5; font-weight: bold; text-decoration: none;">📥 Official EV3-G Example (.ev3) </a>

---

## 🧩 EV3 Exclusive My Blocks Explanation

To make programming in EV3-G more concise and intuitive, the MBC 16-Way Line Follower provides three powerful "My Blocks". During development, you don't need to install cumbersome extension packs; just import the My Blocks, and the system will automatically parse the hardware packets in the background and output the latest sensor data for the motor control logic to use directly.

Here is an introduction to the functions and usage timings of the three core My Blocks:

### 1. Basic Line Following Block: `LinePos16`
...
### 3. Full Array Expansion Block: `LineCh16`
* **Purpose**: Thoroughly decode the 16 sensors into independent states. Applicable for writing custom special intersection judgment algorithms, or drawing the status of the 16 sensors directly on the screen of the EV3 hub.
* **Output Nodes**: Outputs 16 independent values from `s1` to `s16` in one go, perfectly corresponding to the real-time readings of each sensor from left to right.
