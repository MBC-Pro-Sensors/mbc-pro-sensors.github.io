...
<div style="text-align:center; margin: 1.5rem 0;">
  <p style="font-size:1.2rem; color:#aaa; font-family:monospace; letter-spacing:1px;">即插即用 · 官方積木直讀 · 從初學者到競賽頂尖選手的唯一選擇</p>
</div>
...
我們的每一款感應器，都承載著同一個信念：**讓使用者把精力全部放在創意與策略上，而不是在跟硬體搏鬥。**
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 12px; margin: 20px 0;">
  <div style="background: rgba(10,186,181,0.05); border: 1px solid rgba(10,186,181,0.3); border-radius: 8px; padding: 15px;">
    <h4 style="color: #0ABAB5; margin-top:0;">🔌 極致隨插即用</h4>
    <p style="font-size:0.9em; margin-bottom:0;">不需外掛轉接板，直接插上 SPIKE / EV3 即可運作，和接樂高原廠感應器一模一樣。</p>
  </div>
  <div style="background: rgba(10,186,181,0.05); border: 1px solid rgba(10,186,181,0.3); border-radius: 8px; padding: 15px;">
    <h4 style="color: #0ABAB5; margin-top:0;">🧱 官方積木直讀</h4>
    <p style="font-size:0.9em; margin-bottom:0;">軟體端完全相容樂高官方積木，初學者照常拖曳方塊，進階開發者可選用 Python 解鎖更多功能。</p>
  </div>
  <div style="background: rgba(10,186,181,0.05); border: 1px solid rgba(10,186,181,0.3); border-radius: 8px; padding: 15px;">
    <h4 style="color: #0ABAB5; margin-top:0;">🧠 內建智能算法</h4>
    <p style="font-size:0.9em; margin-bottom:0;">複雜的信號處理全部在感應器內部完成，老師不需重複教導，學生接上就能用。</p>
  </div>
  <div style="background: rgba(10,186,181,0.05); border: 1px solid rgba(10,186,181,0.3); border-radius: 8px; padding: 15px;">
    <h4 style="color: #0ABAB5; margin-top:0;">🏆 競賽級可靠性</h4>
    <p style="font-size:0.9em; margin-bottom:0;">每一款產品都在真實比賽環境中反覆驗證，確保在最關鍵的時刻零失誤。</p>
  </div>
</div>
